  ...
  return (
    <LegalLayout title="Terms of Service" updated="July 7, 2026">
      <p>
        ...
        fitviyo.com, including the waitlist. By using Fitviyo, you agree to these
        terms. If you do not agree, please do not use Fitviyo. Questions? Email{" "}
      ...
      <h2>Your account</h2>
      <p>
        Fitviyo works without an account. If you choose to create one, you sign
        in with Apple or Google. You are responsible for keeping access to your
      ...
      <p>
        ...
        to view and copy it within the app. We show only safe details and never
      ...
      <p>
        Fitviyo offers a free tier and an optional <strong>Fitviyo Pro</strong>{" "}
        subscription that unlocks additional features. Pro is an auto-renewing
        subscription sold and billed through the App Store or Google Play. Current
        pricing and any introductory offer are shown in the app at the point of
        purchase. Your subscription renews automatically unless you cancel it at
        least 24 hours before the end of the current period. You manage or cancel
        your subscription in your App Store or Google Play account settings.
        Payments are handled by the app store, and refunds are subject to the app
        store&apos;s policies.
      </p>
      ...
      <p>
        ...
        not guarantee any result. Consult a qualified professional before starting
        or changing any exercise or nutrition program, especially if you have a
        health condition. You use Fitviyo and act on the information in it at your
        own risk. Nutrition data provided through third parties may be incomplete
        or inaccurate.
      </p>
      ...
      <p>
        Fitviyo relies on third-party services, including Apple, Google, FatSecret,
        Supabase, RevenueCat, and OneSignal. Your use of the app through the App
        Store or Google Play is also subject to their terms. Where you download the
        app from the Apple App Store, Apple is not responsible for the app, and
      ...
      <h2>Termination</h2>
      <p>
        You may stop using Fitviyo and delete your account at any time. We may
        suspend or end access if you violate these terms or misuse the service.
        Sections that by their nature should survive termination will continue to
        apply.
      </p>
